...
public class ArticleDashboard_BG_Su {
	public static void main(String[] args) throws InterruptedException {
        ...
        country.selectByVisibleText("BG");
		...
		SHREYA:
  		 for(int j=1;j<=5;j++) {
  			...
  			if(i>10){
                ...
                driver.findElement(By.xpath("//*[@id='root']/div/div[2]/div[2]/div/div[2]/div[3]/div/div/div/div/div[2]/div/ul/a/li[text()='>']")).click();
                Thread.sleep(5000);
...
//				            test.pass(pic);
		       ...
		       try {
		        WebElement pass = driver.findElement(By
                        .xpath("//*[@class='m-toggleButton m-toggleButton-undefined m-toggleButton-isActive']/button"));
	        pass.click();
		        Thread.sleep(5000);
		        	
                WebElement comments = driver.findElement(By.xpath("//div[@class='m-input-elementWrapper']/input"));
               comments.sendKeys("02250 89509 445");
...
//		        }
              ...
              //*[@id='root']/div/div[2]/div[2]/div/div[2]/div[2]/div/div[1]/div/div[1]/div/span[2]/a/*[name()='svg']
                ...
                if(countofinspected_articles==15)
                {
                	break SHREYA;
                }
                int z;
